                    ...
                    <div class="form-group text-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <span class="input-group-addon">$</span>
                                    <asp:TextBox type="number" min="0" step="0.01" class="form-control input-sm" id="input5" required="required" placeholder="В %" runat="server"></asp:TextBox>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <span class="input-group-addon">$</span>
                                    <asp:TextBox type="number" min="0" step="0.01" class="form-control input-sm" id="input7" required="required" placeholder="В %" runat="server"></asp:TextBox>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <span class="input-group-addon">$</span>
                                    <asp:TextBox type="number" min="0" step="1" class="form-control input-sm" id="input8" required="required" placeholder="Във валута" runat="server"></asp:TextBox>
                                </div>
